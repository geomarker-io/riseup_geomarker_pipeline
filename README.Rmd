...
The purpose of the shell scripts is to build a pipeline for geocoding addresses and adding DEGAUSS variables based on geocoded addresses.

Containers used: geocoder, roads, aadt, greenspace, dep_index, drivetime.
